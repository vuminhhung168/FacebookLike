...
String urlUser = 'https://www.facebook.com/profile.php?id=100062213421539'
...
//Verify the button "Follow" is present or not:
    def isPresent = WebUI.verifyElementPresent(findTestObject('Object Repository/Facebook/Page_User/div_contains(Follow)'), 5, FailureHandling.OPTIONAL)
...
//If the button is not present, it maybe hidden:
	if(isPresent == false) {
		...
		isPresent = WebUI.verifyElementPresent(findTestObject('Object Repository/Facebook/Page_User/div_contains(Follow)'), 5, FailureHandling.OPTIONAL)
...
//If the button is present, it means user is not followed, click the button to follow:
	while (isPresent == true) {
		...
		WebUI.waitForElementClickable(findTestObject('Object Repository/Facebook/Page_User/div_contains(Follow)'), 30)
		
		WebUI.click(findTestObject('Object Repository/Facebook/Page_User/div_contains(Follow)'))
